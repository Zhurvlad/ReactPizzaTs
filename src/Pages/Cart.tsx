...
function Cart(){
    ...
    const {clearCart} = DispatchPizzaActions()
    const {items, totalCount, totalPrice} = useTypedSelector(cart => cart.cart)


    const addedPizza = [].concat.apply([], Object.values(items))
                ...
                <div className="container container--cart">
                    <div className="cart">
                        ...
                        <div className="content__items">
                            {addedPizza && addedPizza.map((cartObj:any, index:any) => (<CartItems
                                key={cartObj+index}
                                {...cartObj}/>))}
